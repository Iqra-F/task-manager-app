...
import { CheckCircle2, Eye, EyeOff, User, Mail, Lock, ArrowRight, Sparkles, Sun, Moon } from "lucide-react";

// Loading Skeleton Component (same as login page)
...
export default function RegisterPage() {
  ...
  // Mouse tracking for background effects (same as login page)
  useEffect(() => {
